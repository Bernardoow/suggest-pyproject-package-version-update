...
import SuggestPyProjectPackageVersionUpdate from "./suggestPyProjectPackageVersionUpdate";
...
describe("SuggestPyProjectPackageVersionUpdate Component Tests", () => {
  test("It should has new PyProject.toml area", () => {
    act(() => {
      render(<SuggestPyProjectPackageVersionUpdate />, container);
    });
